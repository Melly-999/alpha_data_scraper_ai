...
def start_scheduler():
    ...
    # Weekly Monday 09:00
    scheduler.add_job(wrapped_weekly, CronTrigger(day_of_week='mon', hour=9, minute=0), id="weekly")
    
    # Monthly 1st day 10:00
    scheduler.add_job(wrapped_monthly, CronTrigger(day=1, hour=10, minute=0), id="monthly")
