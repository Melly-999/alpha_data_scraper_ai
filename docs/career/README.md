...
- [Recruiter case study](recruiter_case_study.md) — full project case study with safety posture and honest limitations.
- [Public launch pack](public_launch_pack.md) — reusable copy for LinkedIn, GitHub profile, CV, recruiter messages and feedback communities.
