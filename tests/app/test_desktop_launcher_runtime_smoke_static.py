...
class TestRuntimeSmokeDocSafetyPosture:
    ...
    def test_dry_run_true(self, doc_text: str) -> None:
        assert "dry_run=true" in doc_text, "runtime smoke doc must declare dry_run=true"
