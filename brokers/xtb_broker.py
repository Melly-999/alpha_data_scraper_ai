...
class XTBBroker(BrokerInterface):
    ...
    def __init__(
        self,
        closed_positions_xlsx_paths: Optional[Union[str, list]] = None,
        cash_operations_xlsx_paths: Optional[Union[str, list]] = None,
        ...
        self._cash_cache: Optional[List[Dict]] = None
